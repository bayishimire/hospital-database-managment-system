...
<?php include 'header.php'; ?>
    ...
    <div class="container--main">
        ...
        <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 3rem;">
            ...
            <div
                ...
                <div style="text-align: right;">
                    <div
                        style="font-size: 0.7rem; font-weight: 800; color: var(--text-muted); text-transform: uppercase;">
                        System Node</div>
        ...
        <div class="card" style="border:none; box-shadow:none; padding:0; background:transparent;">
            ...
            <div class="control-matrix">
                ...
                <a href="billing.php" class="matrix-card">
                    <div class="matrix-icon" style="color: #f43f5e;"><i class="fa-solid fa-file-invoice-dollar"></i>
                    </div>
        ...
        <div class="admin-grid">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h4
                                style="font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); margin:0;">
            ...
            <div class="feature-card">
                <h2 class="feature-title"><i class="fa-solid fa-bolt" style="color: var(--accent);"></i> Real-Time
                    Streams
                </h2>
                            ...
                            <div
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <div style="font-size: 0.75rem; color: var(--text-muted);">From
                                        <?= htmlspecialchars($rp['district'] ?: 'Undisclosed') ?> &bull; Registry Entrance
                                    </div>
                                </div>
                                <div style="font-size: 0.65rem; font-weight: 800; color: var(--text-muted); opacity: 0.6;">
                                    ENTRY
                                </div>
                            </div>
                        <?php endwhile; ?>
                        ...
                        while ($rb = $recent_b->fetch_assoc()):
                            ...
                            <div
                                ...
                                <div style="font-size: 0.65rem; font-weight: 800; color: var(--accent);">
                                    <?= date('H:i', strtotime($rb['billing_date'])) ?>
                                </div>
                            </div>
                        <?php endwhile; ?>
                    </div>
                            ...
                            <div
                                ...
                                <div style="flex: 1;">
                                    ...
                                    <div style="font-size: 0.75rem; color: var(--text-muted);">
                                        <?= htmlspecialchars($rc['first_name']) ?> &rarr; Dr.
                                        <?= htmlspecialchars($rc['dl']) ?>
                                    </div>
                                </div>
                                <div style="font-size: 0.65rem; font-weight: 800; color: #ef4444;">
                                    <?= date('H:i', strtotime($rc['created_at'])) ?>
                                </div>
                            </div>
                        <?php endwhile; ?>
                    </div>
